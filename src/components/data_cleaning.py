...
class DataCleaningConfig:
    cleaned_data_path: str = os.path.join('data', 'data_cleaned.csv')
...
class DataCleaning:
    ...
    def initiate_data_cleaning(self):
        ...
        try:
            ...
            logging.info("Cleaning salary estimate column.") 
            ...
            # handling missing values
            logging.info('Cleaning Industry column.')
            ...
            # handling missing values
            logging.info("Cleaning Sector column.")
            ...
            logging.info("Cleaning Founded column.")
            ...
            # handling missing values
            logging.info("Cleaning ownership column.")
            ...
            # handling missing values 
            # removing unwanted texts 
            logging.info("Cleaning revenue column.")
            ...
            # parsing keywords 
            logging.info("Cleaning job description column.")
            ...
            # saving the file 
            logging.info("Saving the cleaning data.")
            df1.to_csv(self.data_cleaning_config, index=False)
